...
class GetAllMovieReviewUseCase(private val repository: ReviewRepository) {
    suspend operator fun invoke(id : Int): List<ReviewModel> = repository.fetchFromMovie(id)
}