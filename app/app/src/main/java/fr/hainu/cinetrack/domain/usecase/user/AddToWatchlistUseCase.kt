...
class AddToWatchlistUseCase(private val repository: UserRepository) {
    suspend operator fun invoke(filmId: Int): Result<UserModel> = repository.addToWatchlist(filmId)
}
